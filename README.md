...
หรือ Folder ที่ได้ทำการติดตั้ง python เอาไว้ และหา Folder ที่มีชื่อว่า Lib 
และนำไฟล์ไปวางไว้ใน Folder tkinter ค่ะ

(ไฟล์ที่แนบมาจะอยู่ใน Folder Font และ Library นะคะ)
